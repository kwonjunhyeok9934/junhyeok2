...
## 남은 아이디어
사 둔 것: 바코드/영수증으로 담기 · 유통기한 알림 · 담은 것 재구매 추천 · 지출 검색 · 스케줄 반복 · 가계부 CSV 내보내기 · 연간 보기 · 홈 히어로 배경 사진 · 최근 기록 3개 · 여행 탭(일차별 일정·사진, 세계 지도, 홈에 다가오는 여행 D-day 카드, 여행 지출을 거래에 직접 묶기, 여행 만들면 상대에게 알림)
