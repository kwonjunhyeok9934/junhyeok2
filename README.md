...
**사 둔 것**은 윙잇·컬리·쿠팡·마트·편의점에서 산 품목을 미리 담아 두는 곳이다(식비 탭 위쪽 카드).
담을 때 카테고리를 고르고 품목·가격을 적는데, **이때는 가계부에 안 들어간다.** 식비를 적을 때
...
**식비 탭을 처음 쓸 때 한 번**: `supabase/schema.sql` 의 31번 섹션(또는 전체)을 실행해 표를 만든다.
